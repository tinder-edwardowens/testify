...
var (
	pkg       = flag.String("assert-path", "github.com/tinder-edwardowens/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/tinder-edwardowens/testify/_codegen
